...
: "${GIT_TOKEN:=}"                                   # REQUIRED (scope: repo) for the private agentbox-sidecar clone. GITHUB_PACKAGES_TOKEN (below) needs read:packages; one PAT with both scopes can serve as both. Never logged.
